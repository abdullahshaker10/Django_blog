...
def SellerLevel(number):
    ...
    if type(number) == int:
        if number >= 0 and number <= 999:
            return "{}".format("Level 3 Seller")
        elif number >= 1000 and number <= 4999:
            return "{}".format("Level 2 Seller")
        elif number >= 5000 and number <= 10000:
            return "{}".format("Level 1 Seller")
        else:
            return "{}".format("Error, Please Contact the Administrators")
    return "{}".format(number)
...
def badge_logo(text):
    if type(text) == str:
        if text:
            return "{}/{}.svg".format(settings.MEDIA_URL, text)
        else:
            return "{}".format("Error, Please Contact the Administrators")
    return "{}".format(text)
